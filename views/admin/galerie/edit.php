...
<h1>Éditer l'image <?= $image->getName() ?></h1>
<?php if ($success): ?>
...
<?php if (!empty($errors)): ?>
  <div class="alert alert-danger">
    L'image n'a pas pu être modifié
  </div>
<?php endif ?>
<form action="" method="post" enctype="multipart/form-data">
  <div class="form-group">
    ...
    <input type="file" name="image" accept="image/*" value="<?= $image->getUrl()?>" class="form-control">
